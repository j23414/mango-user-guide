...
int i = 2.8;  /* i = 3 */
```
When assigned to an integer variable, Gel will attempt to convert strings to a numberic value. If the string is a number such as "30", the number 30 will be stored as an int. If the string cannot be converted into a number, then zero will be stored in the int.
